import torch
from transfomers import AutoProcessor, AutoModelForCausalLM, BertTokenizer, BertModel
...
class LanguageModel:
	...
	def extract_text_features(self, captions):
		...
		text_model = BertModel.from_pretrained("bert-base-uncased").to(self.device)
